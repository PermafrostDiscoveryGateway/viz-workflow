...
def config_parsl_cluster(
        ...
        max_workers=7,
        cores_per_worker=1, 
        # TODO: automate this follwing string to pull most recent release on github? And add 0.0.+1?
        image='ghcr.io/PermafrostDiscoveryGateway/viz-workflow:0.0.4',
        namespace='pdgrun'):
        ...
        executors=[
            HighThroughputExecutor(
                ...
                provider=KubernetesProvider(
                    ...
                    persistent_volumes=[('pdgrun-dev-0', f'/home/{user}/viz-workflow/docker-parsl-workflow/app')]
                ),
            ),
        ]
    )
