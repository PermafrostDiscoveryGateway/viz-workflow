...
FOOTPRINTS_REMOTE = (
    "/scratch/bbou/julietcohen/IWP/footprint_files_with_date_20230119/high/"
)
...
GEOTIFF_REMOTE = (
    OUTPUT + "geotiff/"
)  # Kastan used pathlib.Path(OUTPUT) / pathlib.Path('merged_geotiff_sep9') for this so if it errors try something similar
    ...
    "statistics": [
        {
            ...
            "val_range": [0, 1],
            "palette": ["#f8ff1f1A", "#f8ff1f"],  # 10% alpha yellow  # solid yellow
            "nodata_val": 0,
