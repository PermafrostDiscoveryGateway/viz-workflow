...
def main():
    ...
    merged_dir_path = f"{IWP_CONFIG['dir_staged']}cn096"  # this path SHOULD NOT be in the `staged_dir_paths_list`
    staged_dir_paths_list = [
        f"{IWP_CONFIG['dir_staged']}cn097",
        f"{IWP_CONFIG['dir_staged']}cn098",
